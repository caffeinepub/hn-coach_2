...
export function BookPage() {
  ...
  // Show login modal immediately if anonymous
  useEffect(() => {
    if (isAnonymous) {
  ...
  // After login, if no name, show name modal
  useEffect(() => {
    if (!isAnonymous && profileFetched && !hasName) {
  ...
  return (
    ...
    >
      ...
      <main className="flex-1 max-w-5xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          <div className="flex items-center gap-3 mb-8">
            ...
            >
              <CalendarCheck className="w-5 h-5" style={{ color: "#FF6A00" }} />
            </div>
            <div>
              <h1
            ...
            >
              ...
              <Calendar
                ...
                styles={{
                  ...
                  day_today: { border: "1px solid #FF6A00", color: "#FF6A00" },
                }}
                    ...
                    {slots.map(([time, available], i) => (
                      <button
                        ...
                        style={{
                          ...
                          color: selectedSlot === time ? "#FFFFFF" : "#1A1A2E",
                        }}
              ...
              <div className="space-y-3">
                {upcomingBookings.map((booking, i) => (
                  <motion.div
                    ...
                    style={{ background: "#FBF7F4", borderColor: "#EDE4D9" }}
      ...
      <LoginModal
        ...
        reason="Sign in to book an appointment with your coach."
      />
